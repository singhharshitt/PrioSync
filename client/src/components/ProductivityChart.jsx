...
const ProductivityChart = ({ data = [] }) => {
    ...
    return (
        <div className="bg-white rounded-2xl p-6 border border-[#2B1B17]/5 shadow-[4px_4px_0_#452215] hover:shadow-[6px_6px_0_#452215] hover:-translate-y-1 transition-all duration-200">
            {/* Header */}
