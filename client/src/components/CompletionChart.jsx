...
const CompletionChart = ({ byTier = {}, byStatus = {} }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* By Priority Tier */}
            <div className="bg-white rounded-2xl p-5 border border-[#2B1B17]/5 shadow-[4px_4px_0_#452215] hover:shadow-[6px_6px_0_#452215] hover:-translate-y-1 transition-all duration-200">
