...
const Sidebar = () => {
    ...
    return (
        <aside
            className={`flex flex-col h-screen bg-[#273751] border-r border-white/5 transition-all duration-300 ${collapsed ? 'w-16' : 'w-60'
                } shrink-0`}
        >
            {/* Logo / Brand */}
            <div className="flex items-center justify-between px-4 py-5 border-b border-white/5">
                ...
                <button
                    ...
                    className="p-1.5 rounded-lg text-[#627890] hover:bg-white/5 hover:text-white transition-colors ml-auto"
                >
            ...
            <div className="px-2 pb-4 border-t border-white/5 pt-3 space-y-1">
                {!collapsed && user && (
                    <div className="px-3 py-2 mb-1">
                        ...
                        <p className="text-xs text-[#627890] truncate">{user.email}</p>
                    </div>
                )}
                <button
