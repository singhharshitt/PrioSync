...
const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header Section */}
      <div className="relative flex items-center justify-between px-6 py-6 border-b border-[#FC703C]/10">
        {/* Logo Area */}
        <div className={`flex items-center gap-3 transition-all duration-500 ${collapsed ? 'justify-center w-full' : ''}`}>
          <div className="relative group cursor-pointer">
            ...
            <PinwheelLogo size={collapsed ? 36 : 40} />
          </div>
          
          {!collapsed && (
            <div className="flex flex-col overflow-hidden">
              <span className="font-black text-[#FDF8F0] text-xl tracking-tighter uppercase leading-none">
      ...
      {collapsed && (
        <button
          ...
          className="absolute top-6 right-[-12px] z-50 w-6 h-12 bg-[#FC703C] rounded-r-lg flex items-center justify-center text-[#2B1B17] hover:bg-[#ff855c] transition-colors shadow-lg shadow-orange-900/20"
