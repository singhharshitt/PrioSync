...
const DependencyPage = () => {
    const { dagData, fetchDAG, fetchTasks, tasks, loading } = useTasks();
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-[#64748b]">
                                Visualizing {dagData?.nodes?.length || 0} tasks and{' '}
                                {dagData?.edges?.length || 0} dependency relationships
                            </p>
                        </div>
                        <button
                            onClick={fetchDAG}
                    ...
                    <div className="card p-5">
                        ...
                        {loading ? (
                            <div className="h-64 flex items-center justify-center">
                                <div className="w-8 h-8 border-2 border-[#604C39] border-t-transparent rounded-full animate-spin" />
                            </div>
                        ) : (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: 'All tasks are loaded into a Max Heap priority queue. O(log n) insert and extract-max for instant top-task retrieval.',
                                    color: '#99A285',
                                },
                                {
                                    step: '3',
                                    title: 'Greedy Scheduling',
                                    desc: 'The algorithm greedily picks the highest-scored available task, respecting dependency order from topological sort.',
                                    color: '#627890',
                                },
                    ...
                    <div className="card p-5">
                        ...
                        <div className="p-4 rounded-xl bg-[#1e2d42] font-mono text-sm text-[#c4a882] overflow-x-auto">
                            Score = (Urgency × 0.30 + Importance × 0.25 + DeadlineProximity × 0.25 + Ease × 0.20) × 20
                        </div>
