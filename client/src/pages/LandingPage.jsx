        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between px-6 py-4 rounded-full
            ...
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-semibold text-2xl text-[#2B1B17] tracking-tight chillax-bold">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link to="/features" className="text-sm font-medium text-[#4A3A36] hover:text-[#FC703C] transition-colors">Features</Link>
              <Link to="/pricing" className="text-sm font-medium text-[#4A3A36] hover:text-[#FC703C] transition-colors">Pricing</Link>
              <Link to="/docs" className="text-sm font-medium text-[#4A3A36] hover:text-[#FC703C] transition-colors">Docs</Link>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link
                to="/login"
                className="hidden sm:block text-sm font-medium text-[#4A3A36] hover:text-[#2B1B17] transition-colors px-4 py-2"
              >
                Log in
              </Link>
              ...
              <Link
                to="/register"
                className="text-sm font-medium text-white bg-[#FC703C] px-5 py-2.5 rounded-full hover:bg-[#E85C2A] transition-all hover:scale-105 hover:shadow-lg"
              >
                Get Started
              </Link>
            </div>
      ...
      <section className="py-24 px-6 bg-[#f8f7f2]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-10 max-w-xl mx-auto">
            Join thousands of productive teams who prioritize smarter, not harder. 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="w-full sm:w-auto px-8 py-4 text-[#2B1B17] font-medium hover:underline underline-offset-4">
              View Pricing →
            </button>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center">
                  <Zap size={16} className="text-[#2B1B17]" />
                </div>
