            ...
            <section ref={heroRef} className="relative bg-[#2B1B17] pt-20 pb-24 px-4 sm:px-6 overflow-hidden">
              ...
              <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-white/40 text-sm uppercase tracking-widest">{`{ Tasks }`}</span>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
              ...
              <div className="min-h-[300px]">
                {loading ? (
                  ...
                  <div className="bg-white rounded-3xl p-12 border border-[#2B1B17]/5 shadow-[4px_4px_0_#452215]">
                    <EmptyState
